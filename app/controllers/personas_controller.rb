  ...
  private
    def persona_params
        params.require(:persona).permit(
          ...
          :amaterno,
          :tipopersona_id,
          :red_id, externo_attributes:[:id, :persona_id, :cvu, estancias_attributes:[:id, :titulo, :responsable, :finicio, :ftermino, :tematica, :notas, :modalidad_id, :tipoestancia_id, :conveniofirm, :cartaacepta]]
        )
    end
